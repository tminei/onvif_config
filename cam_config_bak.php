                        ...
                        <td width="100%" valign="top">
                            ...
                            <form action="cam_config.php" method="post">
                                <form action="cam_config.php" method="post">
                                    ...
                                    <table id="table_cams" width="600" border="1">
                                        <tr><td colspan="2" bgcolor="#696969" align="center"><b style="color: white">IP
                                                    camera 1 settings</b></td></tr>
                                        <tr>
                                            <td align="center" colspan="2">
                                                <table width="100%" border="1">
                                                    <tr>
                                                        ...
                                                        <td align="center" bgcolor="#00558b"><b style="color: snow">Gateway</b></td>
                                                        <td align="center"><input type="text" size="10"
                                                                                  class="input"
                                                                                  name="CAM1_GW"
                                                                                  minlength="7"
